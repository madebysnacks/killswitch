...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var selection = sketch__WEBPACK_IMPORTED_MODULE_0___default.a.getSelectedDocument().selectedLayers;
  var symbols = selection.layers.filter(function (layer) {
    return layer.type == sketch__WEBPACK_IMPORTED_MODULE_0___default.a.Types.SymbolMaster;
  });
  var o = 0;
  if (symbols.length > 0) {
